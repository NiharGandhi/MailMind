  ...
  return (
    <div className="w-full max-w-sm space-y-8 p-8">
      ...
      <div className="text-center">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl" style={{ background: 'var(--accent)' }}>
      ...
      <div className="rounded-xl border p-6 space-y-4" style={{ background: 'var(--surface)', borderColor: 'var(--border)' }}>
        <div className="space-y-1">
          <h2 className="text-base font-medium" style={{ color: 'var(--text)' }}>Sign in to continue</h2>
          <p className="text-xs" style={{ color: 'var(--muted)' }}>
            Connect your Google account to get started with AI-powered email management.
          </p>
        </div>
        ...
        <p className="text-xs text-center" style={{ color: 'var(--muted)' }}>
          MailMind requires access to Gmail and Google Calendar to function.
        </p>
      </div>
    </div>
  )
